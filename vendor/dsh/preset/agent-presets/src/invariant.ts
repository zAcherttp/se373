/**
 * Package-owned invariant companion for `@se373/agent-presets`.
 * @module @se373/agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@se373/agent-presets'

const PACKAGE_NAME = '@se373/agent-presets'

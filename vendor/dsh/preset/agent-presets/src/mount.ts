 ...
 * @module @se373/agent-presets/mount
 */

import { isAbsolute } from 'node:path'
import { pathToFileURL } from 'node:url'
import { Context, type Fiber } from '@se373/cordis'
import { Include } from '@se373/cordis-plugin-include'
import type { EntryTree } from '@se373/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@se373/scope'

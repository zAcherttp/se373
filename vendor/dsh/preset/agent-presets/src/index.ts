 ...
 * @module @se373/agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@se373/cordis'
import z from '@se373/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@se373/scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@se373/agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@se373/settings'

 ...
 * @module @se373/tool-jobs
 */

import type { Context } from '@se373/cordis'
import z from '@se373/schemastery'
import { boundContextSummary, createUserMessage, type ContentBlock } from '@se373/llm'
import { TextRetainer } from '@se373/output-retention'
import { defineTool } from '@se373/tools'
import type { GenericCallView, ToolDefinition, ToolExecution } from '@se373/tools'
import { JobId } from '@se373/jobs'

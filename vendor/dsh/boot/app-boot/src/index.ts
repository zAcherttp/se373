...
import { Context, type FiberState } from '@se373/cordis'
import Loader, { type Entry, type EntryOptions } from '@se373/cordis-plugin-loader'
import Include, { applyEntryPatches, entryListSchema, type PatchOptions } from '@se373/cordis-plugin-include'
import Group from '@se373/cordis-plugin-group'
import { dshHomePath, resolveDshHome } from '@se373/home-paths'
import { createLaunchEnvironmentSnapshot, type LaunchEnvironmentSnapshot } from '@se373/launch-environment'
import type {} from '@se373/cordis-plugin-hmr'
 ...
 * entries (`@se373/cordis-plugin-include`'s `PatchOptions`): id-targeted config
 ...
 * `@se373/cordis-plugin-include` `PatchOptions` (id-targeted config overrides and
...
export async function mountRootInclude(
  ...
  // preset living outside this workspace cannot resolve `@se373/cordis-plugin-group`

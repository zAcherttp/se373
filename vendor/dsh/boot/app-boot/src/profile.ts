...
import type { EntryOptions } from '@se373/cordis-plugin-loader'
import { applyEntryPatches, type PatchOptions } from '@se373/cordis-plugin-include'
import { resolveDshHome } from '@se373/home-paths'
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@se373/base', '@se373/web-app'],
  headless: ['@se373/base', '@se373/headless'],
}

/** Installation-owned bundle tuples normalized to the shipped template. */
const INSTALLATION_OWNED_PROFILE_TUPLES: Record<string, readonly string[]> = {
  headless: ['@se373/base', '@se373/web-app', '@se373/headless'],
}

/** The bundle list a `dsh plugin` init uses for a name with no shipped template. */
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@se373/base']
 ...
 * `@se373/base` (and every other in-box bundle) always comes from

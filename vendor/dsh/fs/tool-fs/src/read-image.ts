 ...
 * @module @se373/tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@se373/cordis'
import { AttachmentError, AttachmentId } from '@se373/attachment'
import type { ImageAttachmentRef, ImageMediaType } from '@se373/attachment'
import type { ContentBlock } from '@se373/llm'
import { defineTool } from '@se373/tools'
import type { GenericCallView, ToolExecution } from '@se373/tools'
import type {} from '@se373/fs'

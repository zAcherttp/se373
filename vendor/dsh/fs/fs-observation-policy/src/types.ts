 ...
 * re-used from `@se373/fs`; this package owns only the observed-state
 * owner structure on top of it.
 *
 * @module @se373/fs-observation-policy/types
 */

/**
 * Minimal structural view of a tool execution the policy plugin needs to derive
 * an observed-state owner. `@se373/tools`' `ToolExecution` contains

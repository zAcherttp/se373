 ...
 * model-facing render consumes ({@link module:@se373/tool-fs-search/search-core}
 ...
 *
 * @module @se373/tool-fs-search/presentation
 */
 ...
 * ({@link module:@se373/tool-fs-search/grep} `formatGrepMatches`), so

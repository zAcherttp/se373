 ...
 * ({@link module:@se373/tool-fs-search/glob} /
 * {@link module:@se373/tool-fs-search/grep}), result parsing,
...
export interface Config {
   ...
   * `@se373/tool-call-timeout-policy` through `exec.signal`.
   */
  timeoutMs?: number
}

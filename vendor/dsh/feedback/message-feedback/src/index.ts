 ...
 * @module @se373/message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@se373/cordis'
import s from '@se373/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@se373/session/surface'
import type { SessionHeader, SessionId } from '@se373/session/types'
import type { SessionInspection } from '@se373/session-persistence'
import type { KvTable } from '@se373/storage-domain'

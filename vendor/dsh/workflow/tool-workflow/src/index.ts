 ...
 * (`@se373/workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @se373/tool-workflow
 */

import type { Context } from '@se373/cordis'
import z from '@se373/schemastery'
import { defineTool } from '@se373/tools'
import type { ToolCallView, ToolResultView } from '@se373/tools'
import type { ContentBlock } from '@se373/llm'
import type { JsonValue, Session, SessionEventMap } from '@se373/session'
import type {

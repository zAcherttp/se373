...
import type { AskUserQuestionItem } from '@se373/user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@se373/user-approval/types'
import type { Message } from '@se373/llm/types'
import type { MessageId } from '@se373/llm/brand'
import type { CallId } from '@se373/llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@se373/session/types'
import type { ToolCallView, ToolResultView } from '@se373/tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@se373/api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),

...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@se373/attachment'
import type { ContentBlock } from '@se373/llm/types'
import type { SessionEvent, SessionId } from '@se373/session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@se373/session-projection/types'

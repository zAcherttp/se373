 ...
 * @module @se373/host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@se373/host-directory-picker-native',
  browse: '@se373/host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@se373/client-ui-directory-picker-native',
  browse: '@se373/client-ui-directory-picker-browse',
}

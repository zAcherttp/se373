/**
 * @se373/web-app — the browser-surface bundle's runtime glue plugin
...
import { addHarnessSourceSection } from '@se373/app-boot'
import * as FrontendStatic from '@se373/host-frontend-static'
import { launchEnvironmentOf } from '@se373/launch-environment'
import { scrubbedParentEnv } from '@se373/subprocess'
import type {} from '@se373/cordis-plugin-loader'
import type {} from '@se373/host-webserver'
...
const DSH_WEB_URL = 'SE373_WEB_URL' as const
...
function resolveDistIndex(): string {
  ...
  try {
    return require.resolve('@se373/web-frontend/dist/index.html')
  } catch {

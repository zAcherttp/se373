/**
 * @se373/headless — one-shot direct Agent driver. The bundle patch
...
import type {} from '@se373/agent-default-model'
...
import type {} from '@se373/cmdline'
...
async function run(ctx: Context, task: string, io: HeadlessIo): Promise<void> {
  ...
  // (@se373/agent-presets README, "Composing a child agent").

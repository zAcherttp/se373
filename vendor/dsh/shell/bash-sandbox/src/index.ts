 ...
 * @module @se373/bash-sandbox
 */

import { Context } from '@se373/cordis'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellRunResult } from '@se373/shell'
import { SandboxUnavailableError } from '@se373/sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
...
import { LocalBashExecutor } from '@se373/bash-local'
import type { Config as LocalConfig } from '@se373/bash-local'
 ...
 * on `ctx.sandboxPolicy` (`@se373/sandbox-policy`), which resolves

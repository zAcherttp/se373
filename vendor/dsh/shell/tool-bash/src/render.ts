 ...
 *
 * @module @se373/tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@se373/shell'
import type { SandboxMode } from '@se373/sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@se373/sandbox'
 ...
 * rendering story, owned by `@se373/shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@se373/shell'

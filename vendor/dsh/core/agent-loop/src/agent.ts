...
import { Inbox, agentEvents, assembleContextFor } from '@se373/agent'
import type { GenerateOptions, LlmCallConfig, Message, PreparedLlmCall } from '@se373/llm'
import {
  BlockAssembler,
  LlmError,
...
import type { Scope } from '@se373/scope'
import { createScope } from '@se373/scope'
import type { EpochHeader, RequestContext, Session, SessionId, TurnEndReason, UserMessage } from '@se373/session'
import { canonicalHeader, headerEquals } from '@se373/session'
import { joinContextSections, renderContextSections, renderPrompt } from '@se373/system-prompt'
import type { PromptAssembly } from '@se373/system-prompt'

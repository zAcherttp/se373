 ...
 * @module @se373/agent-loop/runtime-context
 */

import { createUserMessage } from '@se373/llm'
import type { ContextSnapshotSection } from '@se373/llm'
import type { Session, UserMessage } from '@se373/session'
import { isReplacementSurfaceEvent } from '@se373/session'
import type { Context } from '@se373/cordis'

const SOURCE = '@se373/system-prompt'

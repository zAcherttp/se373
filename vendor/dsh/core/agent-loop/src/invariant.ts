 ...
 * @module @se373/agent-loop/invariant
 */

import type { Context } from '@se373/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@se373/llm'
import type { InvariantFailure, InvariantInstaller } from '@se373/invariants'
import { foldRequestHeader } from '@se373/session'

const PACKAGE_NAME = '@se373/agent-loop'

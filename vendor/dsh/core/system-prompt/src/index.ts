 ...
 *
 * @module @se373/system-prompt
 */

import { Context, Service } from '@se373/cordis'
import z from '@se373/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@se373/scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@se373/scope'
import type { ContextSnapshotSection, ToolSchema } from '@se373/llm'
...
declare module '@se373/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@se373/scope`): scoped listeners

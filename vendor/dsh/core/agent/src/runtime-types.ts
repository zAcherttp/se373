 ...
 * turn/step boundaries remain `@se373/session` events.
 *
 * @module @se373/agent
 */
...
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@se373/llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@se373/session'
export type { AgentCancelCause } from '@se373/session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@se373/system-prompt'
declare module '@se373/system-prompt' {
...
declare module '@se373/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@se373/scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */

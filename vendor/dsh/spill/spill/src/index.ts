 ...
 * `@se373/spill-local` (host filesystem) is the first.
 *
 * The Service Definition is deliberately minimal: `saveText` and nothing else. It owns NO
 * retention policy (that is `@se373/output-retention`), NO tool-result
 * replacement (that is `@se373/spill-policy`), and NO retrieval or

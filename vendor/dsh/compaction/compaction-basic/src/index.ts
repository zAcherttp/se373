 ...
 *
 * @module @se373/compaction-basic
 */

import { Context } from '@se373/cordis'
import z from '@se373/schemastery'
import { CompactionEngine, ManualCompactionError } from '@se373/compaction'
import type { CompactionResult, CompactionTrigger } from '@se373/compaction'
import type { TokenMeter } from '@se373/token-meter'
import type { Session } from '@se373/session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from '@se373/llm'
import type { LlmCallConfig } from '@se373/llm'
import type { Agent, PreStepDecision } from '@se373/agent'
import type { CommandId } from '@se373/commands/brand'
// Type-only: makes the optional sibling service available to `ctx.get()`.
import type {} from '@se373/compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,

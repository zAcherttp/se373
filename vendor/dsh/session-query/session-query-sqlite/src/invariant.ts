/**
 * Package-owned invariant companion for `@se373/session-query-sqlite`.
 * @module @se373/session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@se373/session-query-sqlite'

 ...
 *
 * @module @se373/session-query
 */

import { Context, Service } from '@se373/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@se373/session'
import { foldSessionTitle } from '@se373/session-title'
import type { SessionTitleSnapshot } from '@se373/session-title'
import type {

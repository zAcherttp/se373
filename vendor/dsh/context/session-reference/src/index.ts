 ...
 *
 * @module @se373/session-reference
 */
...
import { createUserMessage, freezeMessage } from '@se373/llm'
import type { ContentBlock, UserMessage } from '@se373/llm'
import type { SessionId } from '@se373/session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@se373/session-query'
import {

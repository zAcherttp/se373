 ...
 *
 * @module @se373/file-reference-local
 */
...
export { FILE_REFERENCE_PROMPT } from '@se373/file-reference'
export { activeAtToken, formatFileMention } from '@se373/file-reference/grammar'

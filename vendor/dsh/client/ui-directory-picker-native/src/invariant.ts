/**
 * Package-owned invariant companion for `@se373/client-ui-directory-picker-native`.
 * @module @se373/client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@se373/client-ui-directory-picker-native'

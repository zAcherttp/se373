 ...
 */
import type { HostDescriptionSource } from '@se373/client-connection/client'
import type { HostObservable, PropsHooks, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@se373/client-ui-slots'
// Type-only: pull the owner SlotMap merges into programs that resolve the
// runtime shares below.
import type {} from '@se373/client-ui-sidebar/client'
import type {} from '@se373/client-ui-conversation/client'
import type {
  SessionId, SessionSearchResultItem, WorkspaceId, WorkspaceView,
} from '@se373/client-runtime/client'

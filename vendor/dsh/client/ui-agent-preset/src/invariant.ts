/**
 * Package-owned invariant companion for `@se373/client-ui-agent-preset`.
 * @module @se373/client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@se373/client-ui-agent-preset'

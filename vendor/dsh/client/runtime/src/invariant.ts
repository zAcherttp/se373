/**
 * Package-owned invariant companion for `@se373/client-runtime`.
 * @module @se373/client-runtime/invariant
 */
...
import type { SlotMap } from '@se373/client-ui-slots'
import type { InvariantInstaller } from '@se373/invariants'

const PACKAGE_NAME = '@se373/client-runtime'

...
import type { GoalSnapshot } from '@se373/goal/client'
import {
...
import type { PropsLocale } from '@se373/client-ui-slots'
...
export type GoalDockProps = import('@se373/client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>

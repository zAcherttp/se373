...
import * as Cordis from '@se373/cordis'
import * as UiSlots from '@se373/client-ui-slots'
import * as UiPrimitives from '@se373/client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@se373/cordis': Cordis,
    '@se373/client-ui-slots': UiSlots,
    '@se373/client-ui-primitives': UiPrimitives,

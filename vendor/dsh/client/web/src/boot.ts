 ...
 * @module @se373/client-web/src/boot
 */
...
} from '@se373/client-modules/client'
import type {} from '@se373/client-ui-renderer/client'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    try {
      ...
      // is `ClientTransportHooks`, owned by @se373/client-connection;

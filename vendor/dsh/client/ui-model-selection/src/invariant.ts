/**
 * Package-owned invariant companion for `@se373/client-ui-model-selection`.
 * @module @se373/client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@se373/client-ui-model-selection'

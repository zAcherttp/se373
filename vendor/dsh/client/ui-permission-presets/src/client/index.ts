 ...
 */
import type { ConnectionHandle } from '@se373/api-remotes/client'
...
import type {} from '@se373/client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@se373/api-remotes/client'
import type { ClientContext, SessionFace } from '@se373/client-runtime/client'
import type { CommandUiContract, SelectOption } from '@se373/client-ui-commands/client'
import type { ClientSessionContext } from '@se373/client-ui-input-trigger/client'
import type { PermissionSelect } from '@se373/permission-presets/client'

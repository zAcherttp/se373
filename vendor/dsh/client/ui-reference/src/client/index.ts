 ...
 * ordering and labels.
 *
 * @module @se373/client-ui-reference/client
 */
...
} from '@se373/client-ui-input-trigger/client'
import { formatFileMention } from '@se373/file-reference/grammar'
import type { FileReferenceCandidate } from '@se373/file-reference/types'
import type { SessionReferenceMentionCandidate } from '@se373/session-reference/types'

/**
 * Package-owned invariant companion for `@se373/client-ui-brand-official`.
 * @module @se373/client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@se373/client-ui-brand-official'

/**
 * Package-owned invariant companion for `@se373/session-persistence-jsonl`.
 * @module @se373/session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@se373/session-persistence-jsonl'

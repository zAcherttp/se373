 ...
 * @module @se373/session-persistence
 */

import { Context, Service } from '@se373/cordis'
import { SessionPreparation } from '@se373/session'
import type { SessionEvent, SessionId, SessionHeader } from '@se373/session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@se373/session'

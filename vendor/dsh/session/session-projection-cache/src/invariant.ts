/**
 * Package-owned invariant companion for `@se373/session-projection-cache`.
 * @module @se373/session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@se373/session-projection-cache'

...
Implementations: [`@se373/sandbox-local`](../sandbox-local/) (Linux: `bwrap`, else the per-platform Landlock launcher; macOS: `sandbox-exec`/Seatbelt). Consumers: [`@se373/bash-sandbox`](../../shell/bash-sandbox/) (wraps `['bash', '-c', command]`).

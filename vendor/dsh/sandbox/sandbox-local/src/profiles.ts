 ...
 *
 * @module @se373/sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@se373/node-addon-landlock-run'
import { writableRoots } from '@se373/sandbox'
import type { SandboxPolicy } from '@se373/sandbox'
 ...
 * (`@se373/fs-sandbox`) can never drift apart.

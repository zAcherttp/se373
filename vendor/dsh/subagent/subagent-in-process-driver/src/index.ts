 ...
 * one result.
 *
 * @module @se373/subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@se373/cordis'
import { foldConsumedWork } from '@se373/agent'
import type { Agent, AgentHandle } from '@se373/agent'
import { SessionId, type SessionEvent, type TurnEndReason } from '@se373/session'
import { createUserMessage, type ContentBlock } from '@se373/llm'
import {

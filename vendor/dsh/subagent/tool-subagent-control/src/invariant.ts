/**
 * Package-owned invariant companion for `@se373/tool-subagent-control`.
 * @module @se373/tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@se373/tool-subagent-control'

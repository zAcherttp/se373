 ...
 * (`@se373/subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@se373/tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@se373/tools'
import type { ContentBlock, MessageId } from '@se373/llm'

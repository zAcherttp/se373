...
import type { Session, SessionEvent } from '@se373/session'
import type { SandboxMode } from '@se373/sandbox'
import { SANDBOX_MODES, effectiveSandboxMode, setSandboxMode } from '@se373/sandbox-policy'
...
import type {} from '@se373/shell'
import type { ApprovalPolicy } from '@se373/user-approval'
import { APPROVAL_POLICIES, effectiveApprovalPolicy, setApprovalPolicy } from '@se373/user-approval'
import { installSettingsSection, settingsNamespace } from '@se373/settings'
...
declare module '@se373/session-projection/types' {

/** Package-owned goal-round prompt invariants. @module @se373/goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@se373/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@se373/goal'
...
const PACKAGE_NAME = '@se373/goal-round-driver'

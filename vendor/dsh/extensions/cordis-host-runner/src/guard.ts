 ...
 * @module @se373/cordis-host-runner/guard
 */

import { Context } from '@se373/cordis'
import type { Plugin } from '@se373/cordis'
import { scopeOf } from '@se373/scope'
import { assertSupportedJsonSchema, defineTool } from '@se373/tools'
import type { ToolDefinition } from '@se373/tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@se373/cordis-client-runner`, whose CTX_VERBS names this one its

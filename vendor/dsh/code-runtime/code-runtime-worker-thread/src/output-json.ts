/** JSON string-prefix accounting for the outer-output ledger. @module @se373/code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@se373/code-runtime'

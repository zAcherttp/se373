import { Context, Service, type Plugin } from '@se373/cordis'
import type { Dict } from '@se373/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@se373/cordis-plugin-loader'
import type { Include } from '@se373/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@se373/cordis-plugin-timer'

 ...
 */
export declare const STRUCTURAL_KINDS: readonly ["row", "group", "include"];
 ...
 */
export declare const FUNCTIONAL_KINDS: readonly ["provider", "tools", "listener"];
 ...
 */
export declare const LIFECYCLE_PHASES: readonly ["pending", "loading", "active", "failed", "unloading"];
/**
 ...
 */
export declare const NODE_ROLES: readonly ["seam", "provider", "core", "tool"];
...
export type GraphJsonValue = null | boolean | number | string | readonly GraphJsonValue[] | {

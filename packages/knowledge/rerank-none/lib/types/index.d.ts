 ...
 */
export declare class PassthroughReranker extends Reranker {
    static readonly name = "rerank-none";
     ...
     */
    rerank<T extends Hit>(_query: string, hits: readonly T[], k: number): Promise<T[]>;
}

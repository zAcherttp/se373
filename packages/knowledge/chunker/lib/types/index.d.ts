 ...
 * Abstract chunker.
 */
export declare abstract class Chunker extends Service {
 ...
 * @returns the chunk.
 */
export declare function buildChunk(document: Document, index: number, text: string, extra?: Record<string, unknown>, title?: string | null): Chunk;
